...
Shader "RyanShader/Rs_BarGraph_Line" {
    Properties {
        ...
        _RandomTime ("RandomTime", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float node_4208 = floor(i.uv0.r * _Density) / (_Density - 1);
                float4 node_6196 = _Time;
                float2 node_6166 = (float2(node_4208,node_4208)+(node_6196.r*0.001*_RandomTime));
                ...
                clip((step((i.uv0.g+(node_4100*_LengthContrast)),_Length)*step(frac((i.uv0.r*_Density)),_Width)*step(_Mask,i.uv0.g)) - 0.5);
////// Lighting:
////// Emissive:
