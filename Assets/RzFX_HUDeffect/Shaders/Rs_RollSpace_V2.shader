...
Shader "RyanShader/Rs_RollSpace_V2" {
    Properties {
        ...
        _PitchSpeed_R ("PitchSpeed_R", Float ) = 1
        _PitchSpeed_G ("PitchSpeed_G", Float ) = -1
        _PitchSpeed_B ("PitchSpeed_B", Float ) = 2
        _PitchSpeed_A ("PitchSpeed_A", Float ) = -0.5
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _PitchSpeed_R;
            uniform float _PitchSpeed_G;
            uniform float _PitchSpeed_B;
            uniform float _PitchSpeed_A;
            struct VertexInput {
...
////// Emissive:
                ...
                float node_6444_ang = node_3052.g;
                ...
                float4 node_3080 = _Time;
                float node_3140_ang = (6.28318530718*frac((_Pitch_R+frac((node_3080.r*_PitchSpeed_R)))));
                ...
                float2 node_6444 = (mul(float2(node_3140.r,((node_3140.g*node_5731)-((node_5731/2.0)-0.5)))-node_6444_piv,float2x2( node_6444_cos, -node_6444_sin, node_6444_sin, node_6444_cos))+node_6444_piv);
                float4 node_8293 = tex2D(_MainTex,TRANSFORM_TEX(node_6444, _MainTex));
                float node_7050_ang = node_3052.g;
                ...
                float node_2140_ang = (6.28318530718*frac((_Pitch_G+frac((node_3080.r*_PitchSpeed_G)))));
                ...
                float2 node_7050 = (mul(float2(node_2140.r,((node_2140.g*node_2436)-((node_2436/2.0)-0.5)))-node_7050_piv,float2x2( node_7050_cos, -node_7050_sin, node_7050_sin, node_7050_cos))+node_7050_piv);
                float4 node_8570 = tex2D(_MainTex,TRANSFORM_TEX(node_7050, _MainTex));
                float node_7418_ang = node_3052.g;
                ...
                float node_6078_ang = (6.28318530718*frac((_Pitch_B+frac((node_3080.r*_PitchSpeed_B)))));
                ...
                float2 node_7418 = (mul(float2(node_6078.r,((node_6078.g*node_146)-((node_146/2.0)-0.5)))-node_7418_piv,float2x2( node_7418_cos, -node_7418_sin, node_7418_sin, node_7418_cos))+node_7418_piv);
                float4 node_3751 = tex2D(_MainTex,TRANSFORM_TEX(node_7418, _MainTex));
                float node_8991_ang = node_3052.g;
                ...
                float node_4177_ang = (6.28318530718*frac((_Pitch_A+frac((node_3080.r*_PitchSpeed_A)))));
                ...
                float2 node_8991 = (mul(float2(node_4177.r,((node_4177.g*node_7220)-((node_7220/2.0)-0.5)))-node_8991_piv,float2x2( node_8991_cos, -node_8991_sin, node_8991_sin, node_8991_cos))+node_8991_piv);
